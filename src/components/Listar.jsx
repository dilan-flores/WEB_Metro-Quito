...
const Listar = ({ estado,setIdmetro}) => {
    ...
    // Use Effect: Se puede utilizar para llamar a una API y se carga la información
    useEffect(() => {
        // Si existe un estado a la ruta mayor a 0
        ...
        // El useEffect se carga:
        // primera vez: cuando el componente se pinta
        // segunda vez: cuando detecta una cambio en estado
    }, [estado])
