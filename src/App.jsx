...
import { Formulario } from './components/Formulario' // asegurarse de importar
import Listar from './components/Listar'
import { useState } from 'react' // Permite trabajar con un estado: Reacciona respecto a una acción


function App() {
  const [darkMode, setdarkMode] = useState(false)

  // useState: variable con una constante que tiene un estado inicial
  // Creación de Sniper
  // setEstado: permite cambiar un estado inicial
      ...
      <main className='container mx-auto flex gap-5 flex-wrap justify-center p-3 lg:flex-nowrap '>
        ...
        <div className='bg-slate-50 w-full m-3 p-5 shadow-lg rounded-lg lg:w-1/2 dark:border-2 border-sky-900'>
          ...
          <div className='mt-10'>
            ...
            {/* importacion de componente <formulario/>*/}
          </div>
        </div>
